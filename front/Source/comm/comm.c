...
void DispMainRxErr(void)
{
    ...
    if( blink < 5U )
    {
        OnOffLed(LED_ID_HOT, PROTOCOL_LED_DUTY_50);
        OnOffLed(LED_ID_ROOM, PROTOCOL_LED_DUTY_50);
        OnOffLed(LED_ID_COLD, PROTOCOL_LED_DUTY_50);
    }
    else
    {
        OnOffLed(LED_ID_HOT, 0U);
        OnOffLed(LED_ID_ROOM, 0U);
        OnOffLed(LED_ID_COLD, 0U);
    }
