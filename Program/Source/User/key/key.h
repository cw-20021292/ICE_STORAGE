...
#define K_MEMENTO          ( K_ICE | K_ICE_WATER )
#define K_MUTE             ( K_COLD | K_AMOUNT )
#define K_ALTITUDE         ( K_HOT | K_AMOUNT )          /// 온수 고도 설정
#define K_ERASE_EEPROM     ( K_ROOM | K_AMOUNT )       /// EEPROM 초기화
#define K_DEICING          ( K_ICE_WATER | K_ROOM )     /// 강제 탈빙

#define K_MANUAL_DRAIN     ( K_ICE_WATER | K_COLD )    /// 강제배수

#define K_TEST_ICE_TRAY    ( K_ICE | K_HOT )      /// 아이스 트레이 검사

#define K_TEMP_MONITOR     ( K_ICE | K_ICE_WATER | K_COLD )   /// 외기온도1 / 외기온도2 / 냉수온도 모니터링

#define K_AGING_TEST       ( K_ROOM | K_HOT | K_AMOUNT )      /// 에이징 테스트

/* FUNCTION KEY - TEST */
#define K_TEST_FCT         ( K_ICE | K_COLD )           /// TEST MAIN PBA
#define K_TEST_FRONT       ( K_ICE | K_AMOUNT )         /// TEST EOL - FRONT
#define K_TEST_MAIN_FRONT  ( K_ICE_WATER | K_AMOUNT )   /// TEST EOL - MAIN FRONT
#define K_TEST_TS          ( K_ICE | K_ROOM )           /// TEST MODE ( TIME SHORT )
...
#define K_TEST_STER_CONTY  ( K_ICE | K_ICE_WATER | K_AMOUNT )   /// TEST, 
