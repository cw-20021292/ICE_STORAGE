...
SKeyEventList_T KeyEventList[] =
{
    ...
    /* MULTI KEY */
    { K_MUTE,           SelSound,       OnOffMute,       NULL,         NULL,              NULL,  NULL, NULL },
    { K_ALTITUDE,       SelSound,       OnOffAltitude,   NULL,         NULL,              NULL,  NULL, NULL },
    { K_DEICING,        SelSound,       OnDeIcing,       NULL,         NULL,              NULL,  NULL, NULL },

    { K_ERASE_EEPROM,   SelSound,       OnEraseEeprom,   NULL,         NULL,                NULL,  NULL, NULL },
    { K_MANUAL_DRAIN,   SelSound,       NULL,            NULL,         OnManualDrainWater,  NULL,  NULL, NULL },

#if( CONFIG_ENABLE_ICON_AIS_ICETRAY_TEST == 1 )
    { K_TEST_ICE_TRAY,  SelSound,       OnTestIceTray,   NULL,         NULL,                NULL,  NULL, NULL },
#endif
...
SKeyEventList_T KeyEventTimeShortList[] =
{
    ...
    { K_ROOM,             SelRoom,          ClearMemento,    NULL,        NULL,    NULL,         NULL, NULL },
    ...
    { K_MEMENTO,          SelSound,         OnOffMemento,    NULL,        NULL,    NULL,         NULL, NULL },
