...
// Buzzer Setting
//==============================================================================
#define TDR_USE		(1)			        // 사용하는 채널
#define TDR_SET		TIMER11_TDR		// 사용하는 TDR

#define	OSC_8MHZ	(0U)			// 사용 1 / 미사용 0
...
//==============================================================================
#if (TDR_USE==0)
#define	SoundStart()		HAL_TIMER10_START()
#define	SoundStop()			HAL_TIMER10_STOP()
#elif (TDR_USE==1)
#define	SoundStart()		HAL_TIMER11_START()
#define	SoundStop()			HAL_TIMER11_STOP()
#elif (TDR_USE==2)
#define	SoundStart()		HAL_TIMER12_START()
#define	SoundStop()			HAL_TIMER12_STOP()
#elif (TDR_USE==3)
#define	SoundStart()		HAL_TIMER13_START()
#define	SoundStop()			HAL_TIMER13_STOP()
#elif (TDR_USE==4)
#define	SoundStart()		HAL_TIMER14_START()
#define	SoundStop()			HAL_TIMER14_STOP()
#elif (TDR_USE==5)
#define	SoundStart()		HAL_TIMER15_START()
#define	SoundStop()			HAL_TIMER15_STOP()
#elif (TDR_USE==6)
#define	SoundStart()		HAL_TIMER16_START()
#define	SoundStop()			HAL_TIMER16_STOP()
#else //(TDR_USE==7)
#define	SoundStart()		HAL_TIMER17_START()
#define	SoundStop()			HAL_TIMER17_STOP()
#endif
...
// Buzzer ID
//==============================================================================
typedef enum _buzzer_id_
{
    BUZZER_OFF = 0,                   /* Power On (제품 공통 ) */
    BUZZER_POWER_ON,                  /* Power Off (제품 공통) */
    BUZZER_EFFLUENT,                  /* 추출 시작 */
    BUZZER_EFFLUENT_END,              /* 추출 완료 */
    BUZZER_COOL_SETUP,                /* 냉각/온수 on */
    BUZZER_COOL_CANCEL,               /* 냉각/온수 off */
    BUZZER_SELECT,                    /* 조절 (온/냉/정수 및 추출량 선택 시 ) */
    BUZZER_ERROR,                     /* 효과음 _ 경고 */
    BUZZER_SETUP,                     /* 잠금 설정 ( 부가 기능 설정 ) */
    BUZZER_CANCEL,                    /* 잠금 풀림 ( 부가 기능 해제 ) */
    BUZZER_EFFLUENT_CONTINUE,         /* 연속 추출 */
    BUZZER_STERILIZE_START,           /* 즉시 살균 시작음 */
    BUZZER_STERILIZE_END,             /* 즉시 살균 완료음 */
    BUZZER_MEMENTO_1,                 /* 메멘토 1 */
    BUZZER_MEMENTO_2,                 /* 메멘토 2 */
    BUZZER_MEMENTO_3,                 /* 메멘토 3 */
    BUZZER_MEMENTO_4,                 /* 메멘토 4 */
    BUZZER_MEMENTO_5,                 /* 메멘토 5 */
    BUZZER_WIFI_SELECT,               /* WIFI 페어링 */
    BUZZER_WIFI_SETUP,                /* WIFI ON */
    BUZZER_WIFI_ERROR,                /* WIFI 불가음 */
    BUZZER_WIFI_CONNECTING,           /* WIFI 연결 중 */
    BUZZER_WIFI_CONNECTED,            /* WIFI 연결 완료 */
    BUZZER_WIFI_FAIL_CONNECTING,      /* WFI 연결 실패 */
    BUZZER_WIFI_DISCONNECTED,         /* WIFI 연결 종료 */
    //BUZZER_BLE_START_CONNECTING,      /* BLE 연결 중 */
    //BUZZER_BLE_CONNTED,               /* BLE 연결 완료 */
    BUZZER_BLE_FAIL,                  /* BLE 연결 실패 */
    BUZZER_MUTE,                      /* 부저음 셋업 전용 */
