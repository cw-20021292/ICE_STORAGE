...
void R_Config_INTC_Create(void)
{
    ...
    PPR17 = 1U;
    PPR07 = 1U;
    EGN0 = _80_INTP7_EDGE_FALLING_SEL | _08_INTP3_EDGE_FALLING_SEL | _04_INTP2_EDGE_FALLING_SEL;
    EGP0 = _00_INTP7_EDGE_RISING_UNSEL | _00_INTP3_EDGE_RISING_UNSEL | _00_INTP2_EDGE_RISING_UNSEL;
    /* Set INTP2 pin */
    PM4 |= 0x80U;
    /* Set INTP3 pin */
    PMCT3 &= 0xFEU;
