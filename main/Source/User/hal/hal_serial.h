...
/* UART CONFIG */
#define CONFIG_USE_UART_0       (1)   // FRONT
#define CONFIG_USE_UART_1       (0)   // WIFI
#define CONFIG_USE_UART_2       (1)   // BLDC COMP
#define CONFIG_USE_UART_3       (1)   // EOL
